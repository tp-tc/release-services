...
#
# COMMAND:
#   pypi2nix -v -V 3.5 -E postgresql mysql zlib openssl -r requirements.txt -r requirements-dev.txt
#
...
let
  ...
  commonBuildInputs = with pkgs; [ postgresql mysql zlib openssl ];
  commonDoCheck = false;
  ...
  generated = self: {
    ...
    "aiohttp" = python.mkDerivation {
      name = "aiohttp-2.0.6";
      src = pkgs.fetchurl { url = "https://pypi.python.org/packages/66/3f/eac06f68743e2654915650de34893391ff1006cd144a48655d2f75084e17/aiohttp-2.0.6-1.tar.gz"; sha256 = "0b285c8a5b2cad31c4040039696ead3cbb8a35fb44eb8ab0b1b7840fba3085f0"; };
      doCheck = commonDoCheck;
      buildInputs = commonBuildInputs;
      propagatedBuildInputs = [
      self."async-timeout"
    ...
    "mysqlclient" = python.mkDerivation {
      name = "mysqlclient-1.3.10";
      src = pkgs.fetchurl { url = "https://pypi.python.org/packages/40/9b/0bc869f290b8f49a99b8d97927f57126a5d1befcf8bac92c60dc855f2523/mysqlclient-1.3.10.tar.gz"; sha256 = "452aaf9d2ba1a4fb85c134c88f9b1857852deed63b3b13255d7a65d2c1297262"; };
      doCheck = commonDoCheck;
      buildInputs = commonBuildInputs;
      propagatedBuildInputs = [ ];
      meta = with pkgs.stdenv.lib; {
